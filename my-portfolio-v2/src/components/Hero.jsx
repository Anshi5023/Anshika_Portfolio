      ...
      >
        ...
        <div>
          <h1 className="text-white text-3xl sm:text-5xl font-semibold">
            Hi, I'm <span className="text-[#915EFF] text-2xl sm:text-4xl font-bold">Anshika Gupta</span>
          </h1>
          <p className="mt-2 text-white-100 text-sm sm:text-base leading-relaxed">
            ...
            building user-focused solutions with modern frameworks, cloud platforms, and ERP systems.
          </p>
        </div>
      </div>
